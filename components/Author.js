        ...
        <div id="author" className="author-container author-container--styles">
            <div className="author-center">
                <div className="author-img-container">
                    <img className="author-img" src="/rolandheadpic.jpg" alt="george orwell picture smoking cigarette" />
                </div>
            </div>
            <div className="summary-container">
                <p className="summary summary--styles">
                    <span className="about-author-title--styles">About the author</span>
                    <br></br>
